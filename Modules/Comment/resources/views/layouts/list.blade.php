...
<head>
    ...
    <title>Loggingpedia | comment list</title>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer d-flex justify-content-end">
                                                                ...
                                                                <form action="/comment/{{ $comment->uuid }}"
