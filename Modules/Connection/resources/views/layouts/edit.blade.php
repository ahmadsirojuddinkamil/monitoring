...
<head>
    ...
    <title>Loggingpedia | edit connection</title>
                            ...
                            <form action="/connection/{{ $connection->uuid }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="endpoint" name="endpoint"
                                        value="{{ $connection->endpoint }}" required>
                                </div>
                                @error('endpoint')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="register" name="register"
                                        value="{{ $connection->register }}" required>
                                </div>
                                @error('register')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="login" name="login"
                                        value="{{ $connection->login }}" required>
                                </div>
                                @error('login')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="get_log" name="get_log"
                                        value="{{ $connection->get_log }}" required>
                                </div>
                                @error('get_log')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="get_log_by_type"
                                        name="get_log_by_type" value="{{ $connection->get_log_by_type }}" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="get_log_by_time"
                                        name="get_log_by_time" value="{{ $connection->get_log_by_time }}" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="delete_log" name="delete_log"
                                        value="{{ $connection->delete_log }}" required>
                                </div>
                                @error('delete_log')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="delete_log_by_type"
                                        name="delete_log_by_type" value="{{ $connection->delete_log_by_type }}"
                                        required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="delete_log_by_time"
                                        name="delete_log_by_time" value="{{ $connection->delete_log_by_time }}"
                                        required>
                                </div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    This connection data will be updated!
                                                </div>
